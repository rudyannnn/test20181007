...
;		Click,Left,%Width%,150
	...
	else
	{
		...
		;WinWaitActive, 빈 페이지 - Windows Internet Explorer provided by LG Display
...
#u::	;U-Dock 새문서 등록
    ...
    WinActivate
click, left,333,183
WinWaitActive, u-DocK - 문서 등록하기 - Windows Internet Explorer provided by LG Display
sleep,1000
click, left,271,173
sleep,100
click, left,242,298
...
click, left,333,183
WinWaitActive, http://edms.lgdisplay.com:8080/?service=create_in_web&node_key=&node_type= - u-DocK - 문서 등록하기 - Windows Internet Explorer provi
sleep,3000
click, left,271,173
sleep,100
click, left,242,298
...
/*
#n::
	IfWinExist 네이버 :: 세상의 모든 지식, 네이버 - Microsoft Internet Explorer
	{
	    WinActivate
	}
	else
...
;
;김판열C
;1part : 박상규C, 김연선J, 이상훈Y, 김사황Y, 임승현Y, 곽선우J, 김종호Y, 이호석Y, 오지훈J, 김선환Y, 조상준C, 최진철J
;2part : 허용준S, 김재기J, 김관선J, 이승주Y, 이태현J, 이영훈Y, 유욱상Y, 김혁진J, 정준태J, 임종하Y, 조수경Y, 조규행J
;3part : 박진우J, 최성훈Y, 정진영C, 최진호J, 서병현Y, 신영식Y, 심소연Y, 김승환J, 김태영J, 김세영Y
;4part : 홍연채S, 변석규S, 이효길S, 임성호J, 이경원Y, 김성중J, 강태욱Y, 정창수J, 이주석Y, 류제승Y
;
...
;D4110D12XX267  All In One TDR 공통 PJT
;D1111DAA55BRU  LC550LUD-MEP1-L31
;D1112DAA55CJT  LC550LUD-MEP2-L31
;D1113DAA55ALK  LC550LUD-LGP1-831

#t::
	clipboard=OLED TV 회로설계1팀
	Send, ^v
	return

#^1::
	clipboard=D1110DTV55582		;LC550EUB-SCA1-831 프로젝트 코드
	Send, ^v
	return
#^t::
	clipboard=47090
;;;;;;	clipboard=40073			;LGDKRA.TV LED 회로설계팀 코드
;;;;;;;;;D1109DTV55495 			;;; LGDKRA.TV 회로설계2팀 코드
	Send, ^v
	return


#k::
	clipboard=foroscar,mj.lee,kbh83,yikim80,rooney,invictus,juranlee ; 오동경, 이문준, 김백환, 김영인, 문경수, 김진욱, 이주란
	Send, ^v
	return

!#k::
	clipboard=이현기, 김영인, 박일권, 김형중, 오동경, 문경수, 편명진, 임이랑, 천현선, 이주란, 정인철, 김진욱, 이상준, 이상재, 오설희, 윤재환, 노현민, 안병석
	Send, ^v
	return
...
+^a::								;;;새문서 등록 EDM
	...
	IfWinExist http://edms.lgdisplay.com:8080 - 문서관리시스템 - 문서 수정 - Microsoft Internet Explorer
	{
		Click,Left,616,169		;;업무분류
		WinWaitActive http://edms.lgdisplay.com:8080 - 문서관리시스템 - 업무분류 - Microsoft Internet Explorer
		sleep, 3000
...
;;;;;;;;413-811 경기도 파주시 월롱면 덕은리 1007번지 LG디스플레이(주) TV 회로설계 2팀 김세영

;;;;;;;;413-811 경기도 파주시 월롱면 덕은리 1007번지 LG디스플레이(주) OLED TV 회로설계 1팀

;;;;;;;;413-811 경기도 파주시 월롱면 덕은리 1007번지 LG디스플레이(주)  All In One TDR 김세영
